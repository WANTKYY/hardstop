...
**Version:** 1.0.0-beta | **License:** CC BY 4.0 | **Author:** Francesco Marinoni Moretto

> **Command:** `/hs` — Enable/disable/skip safety checks
...
**This is an experimental first release (v1.0.0-beta).**

- **No warranty**: This software is provided "as is" without warranty of any kind
- **Not foolproof**: Hardstop cannot guarantee protection against all dangerous commands
- **Pattern evasion**: Sophisticated obfuscation or novel attack vectors may bypass detection
- **Use at your own risk**: Always review commands before execution, even with Hardstop enabled
- **Defense in depth**: Hardstop is one layer of protection, not a complete security solution

### We Need Your Feedback!

This is a community project and we want to make it better. Please:

- **Report issues**: [GitHub Issues](https://github.com/frmoretto/hardstop/issues)
- **Share bypasses**: If you find a command that should be blocked but isn't, let us know
- **Suggest patterns**: Help us expand coverage for new attack vectors
- **Contribute**: PRs welcome for pattern improvements, bug fixes, and documentation
...
> **Remember**: Hardstop is a safety net, not a guarantee. Always exercise caution.
...
4. **New attack vectors** — Novel techniques not in our pattern database may slip through
5. **Context blindness** — Some commands are dangerous only in specific contexts

**Found a bypass?** Please report it: [GitHub Issues](https://github.com/frmoretto/hardstop/issues)
...
> ⚠️ This is a beta release. Please report any issues or bypasses you discover.
